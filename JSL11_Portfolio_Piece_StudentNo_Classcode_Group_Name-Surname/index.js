import {createNewTask, deleteTask, getTasks, patchTasks} from "./utils/taskFunctions.js";
...
const elements = {
  ...
  cancelEditBtn: document.getElementById('cancel-edit-task-btn'),
  cancelAddTakBtn: document.getElementById('cancel-add-task-btn'),
